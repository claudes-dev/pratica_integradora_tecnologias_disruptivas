...
public class TarefaService {
	...
	public Tarefa getByStatusTarefa(Integer statusTarefaId) {

		Optional<StatusTarefa> optionalStatusTarefa = statusTarefaRepository.findById(statusTarefaId);

		return optionalStatusTarefa.flatMap(statusTarefa -> tarefaRepository.findByStatusTarefa(statusTarefa)).orElse(null);
